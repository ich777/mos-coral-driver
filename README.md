# MOS Google Coral Driver

mos-coral-driver provides a **MOS plugin** for managing the Google Coral driver.
...
integrate Coral driver management into MOS.

The plugin enables MOS to download and install Coral driver on demand directly
onto the system.

### Driver Source

- Google Coral: https://github.com/google/gasket-driver
...
Downloaded Google Coral drivers remain licensed under their respective upstream licenses
